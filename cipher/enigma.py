...
std_r={1:rotor_number_i,2:rotor_number_ii,3:rotor_number_iii,4:rotor_number_iv,5:rotor_number_v}
...
def enigma(text, rotor_left_id, rotor_mid_id, rotor_right_id, reflector_id, rotor_key,ringsetting_key,plugboard):
  ...
  rotors= [shift_rotor_n(rotors[i],abc.find(rotor_key[i])) for i in range(len(rotors))] 
  ...
  for counter in range(len(text)):
      ...
      t=reflector[abc.find(t)] #this line is the only difference between encoding and decoding
